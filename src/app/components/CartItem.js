        ...
        <div className="flex gap-x-4 mb-2 ">
            ...
            <div className="flex-1 flex flex-col gap-y-1">
                ...
                <div className="flex flex-col gap-y-1">
                    ...
                    {/*  size*/}
                    <div className="capitalize font-medium text-[15px] mb-2">{pizza.size} size</div>
                    {/*    quantity controls*/}
        ...
        <div className="flex flex-wrap items-center gap-3 p-6 border-b border-black/10">
            ...
            </div>
            {
                pizza.additionalTopping.map((topping, index) => {
                    return (
                        <div key={index} className="capitalize text-sm gradient font-medium px-3 py-1 rounded-full leading-none">
                            {topping.name}
                        </div>
                    )
                })
